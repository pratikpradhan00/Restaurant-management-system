...
public class Nepal {
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (2).jpg"));
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setBounds(-54, 396, 403, 168);
		panel_1.add(lblNewLabel_3);
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (10).jpg"));
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setBounds(243, 263, 112, 147);
		panel_1.add(lblNewLabel_2);
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (11).jpg"));
