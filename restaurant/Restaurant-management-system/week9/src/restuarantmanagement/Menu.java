...
public class Menu {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (1).jpg"));
		lblNewLabel.setBounds(96, 87, 127, 207);
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (2).jpg"));
		lblNewLabel_2.setBounds(26, 92, 229, 166);
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (3).jpg"));
