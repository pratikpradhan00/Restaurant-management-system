...
public class Korean {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (3).jpg"));
		label.setBounds(10, 21, 239, 236);
		panel_1.add(label);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (9).jpg"));
		lblNewLabel_1.setBounds(-23, 267, 401, 333);
