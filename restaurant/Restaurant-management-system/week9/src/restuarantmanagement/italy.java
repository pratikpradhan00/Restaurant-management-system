...
public class italy {
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (7).jpg"));
		lblNewLabel_1.setBounds(41, 10, 254, 302);
		panel_1.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\user\\Downloads\\BeFunky-photo (8).jpg"));
		lblNewLabel_2.setBounds(87, 349, 308, 227);
